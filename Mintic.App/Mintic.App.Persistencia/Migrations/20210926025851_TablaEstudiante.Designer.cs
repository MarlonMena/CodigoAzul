...
namespace Mintic.App.Persistencia.Migrations
{
    ...
    [Migration("20210926025851_TablaEstudiante")]
    partial class TablaEstudiante
    {
            ...
            modelBuilder.Entity("Mintic.App.Dominio.Estudiante", b =>
                {
                    ...
                    b.Property<int?>("NotaEstudianteId")
                        .HasColumnType("int");

                    b.HasIndex("GrupoEstudianteId");

                    b.HasIndex("NotaEstudianteId");
            ...
            modelBuilder.Entity("Mintic.App.Dominio.Estudiante", b =>
                {
                    ...
                    b.HasOne("Mintic.App.Dominio.Nota", "NotaEstudiante")
                        .WithMany()
                        .HasForeignKey("NotaEstudianteId");

                    b.Navigation("GrupoEstudiante");

                    b.Navigation("NotaEstudiante");
                });
